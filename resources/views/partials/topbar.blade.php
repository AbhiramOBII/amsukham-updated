    ...
    <div class="container mx-auto px-6">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center space-x-2">
                ...
                <span class="text-heritage-white/90">+91 98765 43210</span>
            </div>
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="flex space-x-3">
                    <a href="#" class="text-royal-gold hover:text-heritage-white transition-colors">
                    ...
                    <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer" class="text-royal-gold hover:text-heritage-white transition-colors">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
