...
<div class="max-w-3xl">
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-800">Add New Work Type</h2>
        </div>
        
        <form action="{{ route('admin.works.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
            ...
            <div class="flex justify-end gap-3 pt-6 border-t">
                ...
                <button type="submit" class="px-6 py-2 bg-amber-600 text-white rounded-lg hover:bg-amber-700">Create Work Type</button>
            </div>
        </form>
    </div>
</div>
